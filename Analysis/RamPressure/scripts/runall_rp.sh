...
python particletracking_stars.py h242 41 & #1 # python particletracking_stars.py h329 33 & #2
...
python particletracking_stars.py h148 28 & #10 # python particletracking_stars.py h148 68 & #11
wait
