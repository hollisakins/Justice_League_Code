...
## code copied from pynbody source code, to center based on stars instead of gas
...
if __name__ == '__main__':
        ...
        # these numbers have been updated with newest numbers and filepaths with AFH re-ran --- 17 July 2018
        
        nums_h148 = [1, 2, 3, 4, 6, 7, 10, 11, 12, 13, 15, 21, 23, 27, 28, 29, 33, 34, 36, 38, 39, 44, 48, 52, 53, 54, 62, 69, 90, 98, 116, 121, 132, 133, 
                    150, 189, 217, 223, 234, 244, 263, 290, 306, 367, 380, 436, 438, 563, 653, 709, 779, 901, 932, 1090, 1101, 1292, 2297, 4803, 14068]
        nums_h229 = [1, 2, 5, 6, 10, 14, 16, 18, 21, 24, 27, 32, 45, 46, 48, 52, 58, 59, 63, 67, 89, 91, 128, 191, 257, 538, 895, 1253, 1327, 1381, 3661]
        nums_h242 = [1, 4, 10, 21, 27, 31, 35, 37, 45, 47, 48, 49, 67, 71, 81, 102, 131, 407, 418, 1534, 2551, 8678, 9724, 11563]
        nums_h329 = [1, 7, 29, 31, 32, 55, 94, 116, 119, 131, 154, 443, 490, 786, 1182]
        ...
        satsims = [h242,h148,h229,h329]
        satnames = ['h242','h148','h229','h329']
