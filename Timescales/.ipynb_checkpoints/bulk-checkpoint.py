...
def read_sat():
	h148 = '/home/akinshol/Data/DataFiles/h148'
	h229 = '/home/akinshol/Data/DataFiles/h229'
	h242 = '/home/akinshol/Data/DataFiles/h242'
	h329 = '/home/akinshol/Data/DataFiles/h329'
	data = read_file(h148,'h148')
	data = data.append(read_file(h229,'h229'))
	data = data.append(read_file(h242,'h242'))
	data = data.append(read_file(h329,'h329'))
	return data

def read_field():
    cptmarvel = '/home/akinshol/Data/DataFiles/cptmarvel'
    elektra =   '/home/akinshol/Data/DataFiles/elektra'
    rogue =     '/home/akinshol/Data/DataFiles/rogue'
    storm =     '/home/akinshol/Data/DataFiles/storm'
    data = read_file(cptmarvel,'cptmarvel')
    data = data.append(read_file(elektra,'elektra'))
    data = data.append(read_file(rogue,'rogue'))
    data = data.append(read_file(storm,'storm'))
    return data
...
def quenched(data):
    return np.array(data['sSFR']<2e-11)
...
def sat(data,whichhost=False):
    ...
    for i in range(len(data)):
        s = data['sim'].tolist()[i]
        if s=='h148' or s=='h242' or s=='elektra' or s=='h329':
        ...
        elif s=='h229' or s=='h329' or s=='cptmarvel' or s=='rogue' or s=='storm':
...
def distance_to_nearest_host(data):
    ...
    for i in range(len(data)):
        ...
        if s=='h148' or s=='h229' or s=='h242' or s=='h329': # if sat simulation, find distance to halo 1
            ...
            # coords = coords[coords['mass']>1e13]
